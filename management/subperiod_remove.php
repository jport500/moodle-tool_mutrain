...
$subperiod = $DB->get_record('tool_mutrain_framework_subperiod', ['id' => $id], '*', MUST_EXIST);
...
$currenturl = new core\url('/admin/tool/mutrain/management/subperiod_remove.php', ['id' => $id]);
...
$form = new \tool_mutrain\local\form\subperiod_remove(null, [
    'subperiod' => $subperiod,
    'framework' => $framework,
    'context' => $context,
]);
...
if ($form->is_cancelled()) {
    ...
    \tool_mutrain\api::remove_subperiod((int)$subperiod->id);
