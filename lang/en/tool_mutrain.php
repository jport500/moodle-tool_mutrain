...
$string['subperiodrequirements'] = 'Sub-period requirements';
$string['nosubperiods'] = 'No sub-period requirements configured.';
$string['subperiodadd'] = 'Add sub-period';
$string['subperiodremove'] = 'Remove sub-period';
$string['subperiodremoveconfirm'] = 'Remove sub-period "{$a}" and all its category rules?';
$string['subperiodname'] = 'Name';
$string['subperiodmode'] = 'Mode';
$string['subperiodmoderelative'] = 'Relative — offset from member allocation start';
$string['subperiodmodeabsolute'] = 'Absolute — specific calendar dates';
$string['subperiodoffsetdays'] = 'Offset from cycle start (days)';
$string['subperiodlengthdays'] = 'Length (days)';
$string['subperiodstartdate'] = 'Start date';
$string['subperiodenddate'] = 'End date';
$string['subperiodrequiredcredits'] = 'Required credits within this period';
$string['subperiodwindow'] = 'Window';
$string['subperiodcategoryrules'] = 'Category rules';
$string['subperiodcategoryadd'] = 'Add category rule';
$string['subperiodcategoryremoveconfirm'] = 'Remove category rule "{$a->name}: {$a->mincredits}" from this sub-period?';
$string['subperiodnameinvalid'] = 'Name is required.';
$string['subperiodlengthinvalid'] = 'Length must be at least 1 day.';
$string['subperioddatesinvalid'] = 'End date must be after start date.';
$string['subperiodcategoryduplicate'] = 'A rule for this category already exists on this sub-period.';
$string['subperiodmincreditsinvalid'] = 'Minimum credits must be a positive number.';
$string['subperiodrequiredcreditsinvalid'] = 'Required credits must be zero or a positive number.';
